  ...
  <LayoutAuthenticated>
    <SectionMain>
      <div class="flex justify-between items-center mt-3">
        <SectionTitleLineWithButton :icon="mdiFileDocument" title="Certificate of Arrival"/>
      ...
      <template v-else>
        <div>
          <CardBox>
            ...
            <p class="mt-5"><span class="font-bold">Certificate of Arrival:</span>
            ...
            <p class="mt-2"><span class="font-bold mr-3">Review:</span>
...
const upload = async () => {
  ...
  formData.append("type", 'certificate-of-arrival');
...
const getDocument = async () => {
  try {
    const response = await axios.get("http://127.0.0.1:8000/api/documents/"+user.value.id+"?type=certificate-of-arrival");
