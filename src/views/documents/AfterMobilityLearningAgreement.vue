  ...
  <LayoutAuthenticated>
    <SectionMain>
      <div class="flex justify-between items-center mt-3">
        <SectionTitleLineWithButton :icon="mdiFileDocument" title="After the mobility - Learning Agreement"/>
      ...
      <template v-else>
        <div>
          <CardBox>
            ...
            <p class="mt-5"><span class="font-bold">After the mobility - Learning Agreement:</span>
...
const upload = async () => {
  ...
  formData.append("type", 'learning-agreement-after');
...
const getDocument = async () => {
  try {
    const response = await axios.get("http://127.0.0.1:8000/api/documents/"+user.value.id+"?type=learning-agreement-after");
